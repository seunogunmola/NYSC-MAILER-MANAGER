        ...
        <nav class="navbar navbar-expand">
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            ...
                            <div class="header-message-list">
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        <div class="user-online">
                                            <img src="{{ asset('admin/images/avatars/avatar-1.png') }}" class="msg-avatar"
                                                alt="user avatar">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <a class="dropdown-item" href="javascript:;">
                                    <div class="d-flex align-items-center">
                                        <div class="user-online">
                                            <img src="{{ asset('admin/images/avatars/avatar-2.png') }}" class="msg-avatar"
                                                alt="user avatar">
                                        </div>
                                        <div class="flex-grow-1">
            ...
            <div class="user-box dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a onclick="return confirm('Are You Sure You want to Logout?') " class="dropdown-item" href="{{ route('admin.logout') }}">
